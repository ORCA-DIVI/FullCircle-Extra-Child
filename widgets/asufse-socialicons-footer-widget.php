<?php class asufse_SocialIcons_Footer_Widget extends WP_Widget
{
    ...
    public function widget( $args, $instance ) {
        ...
        <?php if ( !empty ( $youtube ) ) : ?>
            <li class="fc-social-icon fc-social-youtube">
        ...
        <?php if ( !empty ( $vimeo ) ) : ?>
            <li class="fc-social-icon fc-social-vimeo">
        ...
        <?php if ( !empty ( $flikr ) ) : ?>
            <li class="fc-social-icon fc-social-flickr">
        ...
        <?php if ( !empty ( $pinterest ) ) : ?>
            <li class="fc-social-icon fc-social-pinterest">
        ...
        <?php if ( !empty ( $snapchat ) ) : ?>
            <li class="fc-social-icon fc-social-snapchat">
        ...
        <?php if ( !empty ( $googleplus ) ) : ?>
            <li class="fc-social-icon fc-social-google-plus">
        ...
        <?php if ( !empty ( $github ) ) : ?>
            <li class="fc-social-icon fc-social-github">
        ...
        <?php if ( !empty($contributeLink) ): ?>
            <p class="button contribute"><a class="btn btn-primary" href="<?php echo $contributeLink; ?>" id="contribute-button-in-footer">Contribute</a></p>
        <?php endif; ?>
