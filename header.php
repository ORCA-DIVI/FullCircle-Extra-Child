...
<body <?php body_class(); ?>>
	...
	<!-- Google Analytics Info, Separate Rollup for FSE -->
	<script>
	  (function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
	  (i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),
	  m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)
	  })(window,document,'script','https://www.google-analytics.com/analytics.js','ga');
	  ga('create', 'UA-11403802-1', 'auto');
	  ga('send', 'pageview');
	</script><!-- end FSE Google Analytics Tracking Code. -->
			...
			<div id="top-header" style="<?php extra_visible_display_css( $header_vars['top_info_defined'] ); ?>">
				<div class="container">
						...
						<div id="et-info" class="top-header-widget-area widget-area" role="complementary">
							<?php if ( is_active_sidebar( 'secondary_bar_widget' ) ) : ?>
							<?php dynamic_sidebar( 'secondary_bar_widget' ); ?>
							<?php endif; ?>
						</div><!-- #et-info -->
